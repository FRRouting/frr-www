...
* pimd: add boundary checks when parsing join/graft source lists (coverity) (backport #18989)
...
* Fix some coverity issues (backport #18897)
* Add frr-host yang module - fix bug with reserved IP range config (backport #19019)
...
* Nhrp redundancy ping (backport #19048)
...
* Doc and test update (backport #19070)
...
* bgpd: fix missing BGP_ROUTE_AGGREGATE for announcing to zebra (backport #19105)
...
* bgpd: free json objects in error paths (backport #19158)
